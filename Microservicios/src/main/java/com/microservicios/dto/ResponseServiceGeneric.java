...
@XmlRootElement
public class ResponseServiceGeneric {

    public ResponseServiceGeneric() {
    ...
    /*
	 * public ErrorMessage(AppException ex){ try {
	 * BeanUtils.copyProperties(this, ex); } catch (IllegalAccessException e) {
